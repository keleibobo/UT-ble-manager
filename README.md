# ut-ble-manager
> a fork of react-native-ble-manager
...
```shell
react-native link ut-ble-manager
```
...
#### iOS
- Open the node_modules/ut-ble-manager/ios folder and drag BleManager.xcodeproj into your Libraries group.
...
include ':ut-ble-manager'
project(':ut-ble-manager').projectDir = new File(rootProject.projectDir, '../node_modules/ut-ble-manager/android')
```
##### Update Gradle Build
...
dependencies {
    ...
    compile project(':ut-ble-manager')
}
```
